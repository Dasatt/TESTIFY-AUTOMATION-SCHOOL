...
public class WidgetPage {
    ...
    @Test
    public void widgetTile(){
        WebElement widgetTile = driver.findElement(By.xpath("//body[1]/div[2]/div[1]/div[1]/div[2]/div[1]/div[4]"));
        widgetTile.click();
        String currentUrl = driver.getCurrentUrl().toLowerCase();

        SoftAssert obj = new SoftAssert();
        obj.assertEquals(currentUrl, "https://demoqa.com/widgets");
        System.out.println("Completed Widget Page Check");
        obj.assertAll();
        driver.quit();
